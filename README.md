...
<body>
            ...
            <div class="card border-0">
                ...
                <div class="card-body">
                    <form id="banner-form">
                        ...
                        <div class="mb-3">
                            <label for="banner-url" class="form-label">لینک بنر (اختیاری)</label>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="upload-btn-wrapper btn btn-outline-secondary w-100">
                                <button class="btn"><i class="bi bi-upload"></i> آپلود تصویر</button>
                                <input type="file" id="banner-image-upload" accept="image/*" required>
                            </div>
                            <div id="banner-image-preview" class="mt-2 text-center" style="display: none;">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="user-list">
                                <div id="admin-user-item" class="chat-user p-2 mb-2 rounded d-flex align-items-center" onclick="showUserProfile('admin')" style="display: none;">
                    ...
                    <div id="profile-view">
                        <div class="row">
                            <div class="col-md-4 text-center">
                                <img src="https://ui-avatars.com/api/?name=کاربر+لینکدونی&size=100&background=0d6efd&color=fff" class="profile-avatar mb-3" id="profile-avatar">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="edit-name" value="کاربر لینکدونی">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div id="admin-banners-container">
                                    <div class="empty-state">
                                        <i class="bi bi-images"></i>
                                        <h5>هنوز بنری برای مدیریت وجود ندارد</h5>
    ...
    <div class="modal fade profile-modal" id="userProfileModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="profile-header">
                    <img src="" class="user-avatar mb-2" id="modal-user-avatar">
                    <h5 class="mb-0" id="modal-user-name"></h5>
                    <p class="mb-0" id="modal-user-role"></p>
                </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-6">
                            <div class="card text-center">
                                <div class="card-body">
                                    <h6>تعداد پیام‌ها</h6>
                                    <h4 id="modal-user-messages">0</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="d-grid">
                        <button type="button" class="btn btn-outline-primary" data-bs-dismiss="modal">بستن</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        let userProfile = {
            ...
            phone: "09121234567",
            avatar: "https://ui-avatars.com/api/?name=کاربر+لینکدونی&size=100&background=0d6efd&color=fff",
            joinDate: "1402/05/01",
            bannersCount: 0,
            messagesCount: 0,
        ...
        function showUserProfile(userId) {
            ...
            if (userId === 'admin') {
                document.getElementById('modal-user-avatar').src = "https://ui-avatars.com/api/?name=ادمین&background=007bff";
                document.getElementById('modal-user-name').textContent = "مدیر سیستم";
                document.getElementById('modal-user-role').innerHTML = '<span class="badge bg-primary">ادمین</span>';
                document.getElementById('modal-user-banners').textContent = "0";
                document.getElementById('modal-user-messages').textContent = "0";
            }
                            ...
                            <div class="card banner-card h-100">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ${banner.url ? `<a href="${banner.url}" class="btn btn-primary btn-sm">مشاهده</a>` : ''}
